...
/datum/disease_property/symptom/nano_boost/Start(datum/disease/advance/A)
	if(!..())
		return
...
/datum/disease_property/symptom/nano_boost/Activate(datum/disease/advance/A)
	if(!..())
		return
...
/datum/disease_property/symptom/nano_destroy/Start(datum/disease/advance/A)
	if(!..())
		return
...
/datum/disease_property/symptom/nano_destroy/Activate(datum/disease/advance/A)
	if(!..())
		return
	var/mob/living/carbon/M = A.affected_mob
